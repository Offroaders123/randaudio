...
pub struct ModulatedSawWaveStream {
    sample_rate: u32,
    channels: u16,
    duration: Duration,
...
impl Iterator for ModulatedSawWaveStream {
    type Item = i16;
...
impl Source for ModulatedSawWaveStream {
